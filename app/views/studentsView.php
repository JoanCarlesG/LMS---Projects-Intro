...
<!-- 20.Des.2022 - EXEMPLE DE TAILWIND TEMPLATES - GRID DE ELEMENTS AMB BOTONS delete y edit (opcionals)  -->
...
<!--- more free and premium Tailwind CSS components at https://tailwinduikit.com/ --->
            <div class="px-4 md:px-10 py-4 md:py-7">
                <div class="flex items-center justify-between">
                    <p tabindex="0" class="focus:outline-none text-base sm:text-lg md:text-xl lg:text-2xl font-bold leading-normal text-gray-800">STUDENTS</p>
            ...
            <div class="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10">
                <div class="sm:flex items-center justify-between">
                    ...
                    <button onclick="popuphandler(true)" class="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600 mt-4 sm:mt-0 inline-flex items-start justify-start px-6 py-3 bg-indigo-700 hover:bg-indigo-600 focus:outline-none rounded">
                        <p class="text-sm font-medium leading-none text-white">Add New Student</p>
                    </button>
                </div>
            ...
            <!-- while($row = mysqli_fetch_array($result)) {  ?> -->
                            ...
                            <tr tabindex="0" class="focus:outline-none h-16 border border-gray-100 rounded">
                                ...
                                <td class="">
                                    <div class="flex items-center pl-5">
                                        <p class="text-base font-medium leading-none text-gray-700 mr-2">Nom estudiant primer de la bd</p>
                                ...
                                <td class="pl-4">
                                    ...
                                    <a href="controllers/SingleStudentController.php?id=<?php echo $_row['id_student'] ?> " class="btn btn-secondary">Show student details</a>
                                    <!-- </button> -->
                                </td>
                                <td>
                            ...
                            <tr tabindex="0" class="focus:outline-none  h-16 border border-gray-100 rounded">
                                ...
                                <td  class="focus:text-indigo-600 ">
                                    <div class="flex items-center pl-5">
                                        <p class="text-base font-medium leading-none text-gray-700 mr-2">Nom estudiant segon de la bd</p>
                                    </div>
                                </td>
                                <td class="pl-24">
                                    <div class="flex items-center">
